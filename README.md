...
Para que esta parte funcione, debes asegurarte de que has generado todos los archivos necesarios. Si no estás seguro:
     - Descarga el localiser.cdsl que se encuentra en este git.
     - Desde una terminal, vete donde has descargado el localiser.dsl, preferiblemente, en una carpeta donde solo esté este archivo para mantenerlo limpio.
     - Ejecuta:
```
...
Este comando generará varias carpetas, entre ellas, la carpeta src y generated, las cuales usaremos más adelante.
     - Copia todo el contenido de la carpeta src del github a la carpeta src de tu equipo local.
     - Copia todo el contenido de la carpeta generated del github a la carpeta generated de tu equipo local.
